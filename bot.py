...
# --------------------------------------------PRINTING ALL CONTACTS--------------------------------------------#
        ...
        for contact in list_of_contacts:
            table.add_row(contact["name"], contact["last_name"], contact["_phone"], contact["_email"],contact["_date_of_birth"], contact["address"], contact["note"])
...
# ----------------------------------------------BIRTHDAY SEARCHING----------------------------------------------#
        ...
        if no_of_days.isdigit():
            ...
            for contact in list_of_contacts_with_bday:
                table.add_row( contact["name"], contact["last_name"], contact["_date_of_birth"])
...
# ----------------------------------------------NOTES SEARCHING----------------------------------------------#
        ...
        #     table.add_row(note["note"], note["name"], note["last name"])
        console.rule(style=RULER)
        ...
        table.add_row(f"edit <[{COMMAND}]No[/]>", f"Edit note <[{COMMAND}]No[/]>")
        ...
        while True:
            ...
            if option.startswith("edit"):
                note_to_edit = option.replace("edit", "").strip()
                while True:
                    new_note = console.input(
                        f"Enter new note: ").casefold()

                    try:

                        console.print(f"The tags: {new_tags} have been added to note.")
                        break
                    except:
                        console.print(":warning: Something went wrong. Try again.", style=COMMAND_ERROR)
            ...
            if option.startswith("tag"):
                ...
                try:
                    ...
                    console.print(f"The tags have been removed.")
                    break
                except:
                    console.print(":warning: Something went wrong. Try again.", style=COMMAND_ERROR)
